...
export default function Unete() {
  const [form, setForm] = useState({
    nombre: "", ciudad: "", direccion: "", telefono: "", web: "",
    ...
    return (
      <main style={{ background: "#FFF8EF", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem" }}>
        <div style={{ textAlign: "center", maxWidth: "420px" }}>
          ...
          <h1 style={{ fontSize: "1.6rem", fontWeight: 900, color: "#1C1917", marginBottom: "0.75rem" }}>¡Solicitud recibida!</h1>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <div style={{ background: "white", borderRadius: "1.25rem", border: "1px solid #F5E6D3", padding: "1.5rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div>
              ...
              <input style={input} required value={form.nombre} onChange={e => set("nombre", e.target.value)} placeholder="Bar El Tardeo" />
            </div>
          ...
          <button type="submit" disabled={status === "loading"} style={{
            ...
            {status === "loading" ? "Enviando..." : "Apuntar mi local →"}
          </button>
