...
export async function onRequestGet(context) {
  ...
  return Response.json({ local, email: user.email, plan: user.plan, trial_inicio: user.trial_inicio, plan_expires: user.plan_expires || null, slug: user.slug, verified: user.verified === 1, locales: userLocales, theme: user.theme || null });
}
